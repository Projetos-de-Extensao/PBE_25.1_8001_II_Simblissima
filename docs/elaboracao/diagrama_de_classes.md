...
<p align = "justify">
Para a criação da primeira versão do diagrama de classes, a equipe utilizou o programa... Além disso, foi utilizado Discord e WhatsApp para videoconferência e Visual Studio Code / Live Share para elaboração da documentação.
</p>
...
![![Diagrama de Classes](../assets/PlantUML/UMLDiagramaDeClasses.png)](../assets/PlantUML/UMLDiagramaDeClasses.png)
